	...
	create_particle_point(1, s_id, 0x4444ffcf,
	{a1 = 10fx, a2 = 30fx, type = "circle", p = 7fx, condition = "lenght"}, {v = 51fx, r = 7fx}, {"dot"},
	{dx = 0fx, dy = 0fx, r = 0fx, type = "r_delay"}, {ds = 0fx, rs_type = "null", da = 0fx, r_type = "null"})
	...
	{a1 = 10fx, a2 = 30fx, type = "ring", p = 100, condition = "chance"}, {v = 63fx, r = 11fx}, {"square"},
	...
	function level_tick()
		...
		if not death then
			...
			if time % 20 == 0 then
				local x, y = pewpew.entity_get_position(s_id)
