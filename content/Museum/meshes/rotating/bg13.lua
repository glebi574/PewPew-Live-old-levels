...
for k=0,mn2 do
local z=r3*math.cos(k*segm2)*(0.99+(k%2)*0.02)
for i=1,mn1 do
local x=math.sin(i*segm1)*r1*math.sin(k*segm2)*(0.95+(k%2)*(i%2)*0.1)
local y=math.cos(i*segm1)*r2*math.sin(k*segm2)*(0.95+(k%2)*(i%2)*0.1)
