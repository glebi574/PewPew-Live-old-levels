...
if r1==1 then c1=0xff999955 end
if r1==2 then c1=0xffff9955 end
if r1==3 then c1=0x66ff6655 end
...
local z1=c_vertexes[r2][3]
for i=0,i2,1 do
if c_vertexes[r3]~=nil then
local x2=c_vertexes[r3][1]
local y2=c_vertexes[r3][2]
local z2=c_vertexes[r3][3]
if math.abs(x1-x2)<100 and math.abs(y1-y2)<100 and math.abs(z1-z2)<100 then
