...
local text='every second room contains some danger|every room before it contains a bonus|the red room contains a boss,|victory over which opens access|to the green rooms|the walls are a little sticky'
